...
<body>
    ...
    <header>
        ...
        <nav> 
            <div class="nav-left"> 
                <a href="#" class="back-btn">Atrás<i class="fas fa-arrow-left"></i></a> 
            </div> 
            <div class="nav-right">
                <div class="user-info"> 
    ...
    <div class="plano-casa">
        <div class="vivienda-container">
            <div class="vivienda">
                ...
                include_once('obtener_colores.php'); // Archivo donde definimos la función obtenerColorPorTemperatura
                ...
                // Definir los colores para cada habitación
                $colores = [
                    'Habitacion1' => obtenerColorPorTemperatura($sensores['Habitacion1']),
                    'Habitacion2' => obtenerColorPorTemperatura($sensores['Habitacion2']),
                    'Banyo' => obtenerColorPorTemperatura($sensores['Banyo']),
                    'Dormitorio' => obtenerColorPorTemperatura($sensores['Dormitorio']),
                    'Salon' => $colorSalon,
                ];
                ?>
    ...
    <script type="text/javascript">
        // Pasar los colores de las habitaciones a JavaScript
